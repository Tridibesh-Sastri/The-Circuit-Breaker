            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="#events" className="text-sm text-gray-400 hover:text-emerald-400 transition-colors">
                      Events
                    </Link>
                  </li>
                  <li>
                    <Link href="#library" className="text-sm text-gray-400 hover:text-emerald-400 transition-colors">
                      Library
                    </Link>
                  </li>
                </ul>
